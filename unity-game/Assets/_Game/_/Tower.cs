...
public class Tower : MonoBehaviour {
    ...
    private void Start() {
        World_Bar healthBar = new World_Bar(transform, new Vector3(0, 30), new Vector3(15, 1.2f), Color.grey, Color.red, 1f, 1000, new World_Bar.Outline { color = Color.black, size = .5f });
